...
const Media = () => {
  ...
  return (
    <div className="media bg-black text-white px-[5%] lg:px-[10%] py-16">
        ...
        {articles.map((article, index) => (
          ...
          >
            <motion.div
              ...
              className="bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-red-500/30 transition-all duration-300 cursor-pointer"
            >
              {images[index] && (
                <img
                  src={images[index]}
